...
const PORTAL_ID = "default-portal";
...
type Props<I, O> = {
  ...
  defaultArgument: I,
  children: ReactNode,
  context: React.Context<(argument: I) => Promise<O>>,
};
//type ToRenderModalProps<I, O> = {
//  modalRender: ReactElement,
//  show: (argument: I) => Promise<O>,
//};

export const ModalDialog = <I, O = void>({
  dialogElement,
  defaultArgument,
  children,
  context,
//}: Props<I, O>): ToRenderModalProps<I, O> => {
